...
![no gocd if you don't need pipeline](https://docs.go.cd/16.4.0/resources/images/concepts/04_pipeline.png)
...
![value stream map](https://docs.go.cd/16.5.0/resources/images/whole_map.png)
...
![dedicated artifact repository](/images/gocd-tips/dedicated-artifact-repository.png)
...
![gocd pipeline as code](https://docs.go.cd/16.12.0/resources/images/advanced_usage/pipelines_as_code.png)
...
![my general pattern](/images/gocd-tips/deploy-config-changes.png)
